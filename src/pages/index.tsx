  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine, where dining reservations meet seamless management. Simplifying your restaurant experience, one booking at a time."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine, where dining reservations meet seamless management. Simplifying your restaurant experience, one booking at a time.`}
            </Text>
            <Box
